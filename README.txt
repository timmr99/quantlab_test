Quantlab test problem solution README.txt

* Description of problem

This problem will require you to write an application that will read an input

file ('input.csv') and write out a new file calculated from the inputs. Please

use any popular system programming language, knowing that we prefer Python.



We are looking for an easily extendable solution with a strong emphasis on

readability, even though it may not seem required for this application. We

expect to be able to easily run the solution from what you provide.  We will

evaluate your submission based on the following criteria:
...
- Idiomatic usage of chosen language

- Ability to easily use the solution

- Correctness



We are big fans of test driven development (TDD) and SOLID design principles.

Please aim to spend about an 1-2 hours to complete this exercise. Send your

source code, git repository, and output.csv in an easy to deploy and run

technology back for evaluation when complete. Include the amount of time you

spent working on the solution.
...
python3 ./quantlab_test/process.py -f data/input.csv -o output.csv
